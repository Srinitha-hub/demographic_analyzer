...
def calculate_demographic_data(print_data=True):
    ...
    lower_education_rich = (df[~higher_education & (df['salary'] == '>50K')].shape[0] / df[~higher_education].shape[0]) * 100
    ...
    percentage_by_country = (high_earners['native-country'].value_counts() / df['native-country'].value_counts()) * 100
    ...
    top_IN_occupation = high_earners[high_earners['native-country'] == 'India']['occupation'].value_counts().idxmax()
